...
public final class CharacterLiteralsChannel extends Channel<Lexer> {
    ...
    public boolean consume(final CodeReader code, final Lexer output) {
        ...
        output.addToken(Token.builder().setLine(line).setColumn(column)
                ...
                .setType(ObjectiveCTokenType.CHARACTER).build());
        sb.setLength(0);
        return true;
    }
    ...
    private void readPrefix(final CodeReader code) {
